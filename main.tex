...
\begin{enumerate}
  \item[(i)] $x, x^2$
    ...
    \boxedanswersmall{
      ...
      Or on any other choice interval.
...
\inputminted{julia}{./calculations/calculations.jl}
